            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <div className="flex gap-4">
                  <div>
                    <label htmlFor="focus-time" className="block text-sm mb-1">
                      Enfoque
                    </label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label htmlFor="break-time" className="block text-sm mb-1">
                      Descanso
                    </label>
                    <input
                      type="number"
              ...
              <div className="mb-6">
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="alarm-sound" className="block text-sm mb-1">
                      Sonido de Alarma
                    </label>
                    <select
                      id="alarm-sound"
                  ...
                  <div>
                    <label htmlFor="focus-music" className="block text-sm mb-1">
                      Música para enfocarme
                    </label>
                  ...
                  <div>
                    <label htmlFor="break-music" className="block text-sm mb-1">
                      Música para el break
                    </label>
                    <div className="flex items-center gap-2">
                      <input
                        type="text"
